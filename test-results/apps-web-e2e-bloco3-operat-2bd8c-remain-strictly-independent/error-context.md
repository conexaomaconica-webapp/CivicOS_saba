...
- Name: apps\web\e2e\bloco3-operational-integration.spec.ts >> BLOCO 3.1: Operational Integration & E2E Verification >> admin publication status and founder allocation remain strictly independent
- Location: apps\web\e2e\bloco3-operational-integration.spec.ts:55:7
...
Call log:
  - navigating to "/admin/aprovacoes", waiting until "load"
