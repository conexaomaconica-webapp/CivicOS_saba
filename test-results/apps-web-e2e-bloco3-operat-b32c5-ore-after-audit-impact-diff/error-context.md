...
- Name: apps\web\e2e\bloco3-operational-integration.spec.ts >> BLOCO 3.1: Operational Integration & E2E Verification >> admin quota update flow requires platform_admin and shows before/after audit impact diff
- Location: apps\web\e2e\bloco3-operational-integration.spec.ts:32:7
...
Call log:
  - navigating to "/admin/settings/planos", waiting until "load"
