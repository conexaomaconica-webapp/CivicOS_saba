...
- Name: apps\web\e2e\bloco3-operational-integration.spec.ts >> BLOCO 3.1: Operational Integration & E2E Verification >> submit review flow creates pending review and updates average rating after admin approval
- Location: apps\web\e2e\bloco3-operational-integration.spec.ts:4:7
...
Call log:
  - navigating to "/guia/empresa-bronze", waiting until "load"
