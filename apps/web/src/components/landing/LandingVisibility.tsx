        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm font-semibold text-slate-200">
              <div className="p-3 bg-slate-900 rounded-lg border border-slate-800 flex items-center gap-2">
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-br from-[#C9A227]/10 via-slate-900 to-slate-950 border border-[#C9A227]/30 space-y-6">
