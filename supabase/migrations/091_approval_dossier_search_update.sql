-- Migration 091: Update get_admin_approval_directory_list RPC to return cnpj_cpf and city

DROP FUNCTION IF EXISTS public.get_admin_approval_directory_list();
