...
CREATE INDEX idx_founder_qualifications_tenant ON public.founder_qualifications(tenant_id);
...
CREATE INDEX idx_sponsorships_tenant ON public.sponsorships(tenant_id);
...
CREATE INDEX idx_sponsorship_periods_sponsorship ON public.sponsorship_periods(sponsorship_id);
