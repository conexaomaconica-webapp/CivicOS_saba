...
CREATE UNIQUE INDEX uq_roles_global_code ON public.roles(code) WHERE tenant_id IS NULL;
CREATE UNIQUE INDEX uq_roles_tenant_code ON public.roles(tenant_id, code) WHERE tenant_id IS NOT NULL;
