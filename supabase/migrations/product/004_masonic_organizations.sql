...
CREATE INDEX idx_organization_units_org ON public.organization_units(tenant_id, organization_id);
...
CREATE INDEX idx_organization_people_org ON public.organization_people(tenant_id, organization_id);
CREATE INDEX idx_organization_people_user ON public.organization_people(user_id);
...
CREATE INDEX idx_org_memberships_person ON public.organization_memberships(person_id);
...
CREATE INDEX idx_org_relationships_source ON public.organization_relationships(tenant_id, source_organization_id);
CREATE INDEX idx_org_relationships_target ON public.organization_relationships(tenant_id, target_organization_id);
...
CREATE INDEX idx_org_event_link_org ON public.organization_event_link(tenant_id, organization_id);
...
CREATE INDEX idx_org_biz_partnership_org ON public.organization_business_partnership(tenant_id, organization_id);
CREATE INDEX idx_org_biz_partnership_biz ON public.organization_business_partnership(tenant_id, business_id);
