-- Migration 058: Business Favorites Batch Search RPC Evolution
-- Adds p_slugs text[] DEFAULT NULL parameter to public_businesses_search RPC
-- and enables b.slug matching in general text search queries.
